...
import { uploadImageToSupabase, deleteImageFromSupabase, formatFileSize, compressImage } from '../../services/supabase-imageUpload'
...
function ImageManager({ images = [], onChange, title = "Product Images", folder = "products" }) {
  ...
  const handleFileSelect = async (files) => {
    ...
    try {
      ...
      alert(`Image add failed: ${error.message}`)
      setUploading(false)
      setUploadProgress(0)
    }
  }
